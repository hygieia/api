...
public class DataSyncServiceTest {
    ...
    public void dataCleanGIT() {
        ...
        when(dataSyncService.getCollectorItemRepository().findById(any(ObjectId.class))).thenReturn(java.util.Optional.of(getGitRepo(collectorItemId, "http://github.com/repo1", "master")));
    ...
    public void dataCleanSonar() {
        ...
        when(dataSyncService.getCollectorItemRepository().findById(any(ObjectId.class))).thenReturn(java.util.Optional.of(getSonarProject(collectorItemId, "sonarProjectName1", "http://sonarqube.com")));
    ...
    public void dataCleanArtifact() {
        ...
        when(dataSyncService.getCollectorItemRepository().findById(any(ObjectId.class))).thenReturn(java.util.Optional.of(getArtifactItem(collectorItemId, "artifactName1", "repoName", "path", "http://artifactory.com")));
    ...
    public void dataCleanStaticSecurity() {
        ...
        when(dataSyncService.getCollectorItemRepository().findById(any(ObjectId.class))).thenReturn(java.util.Optional.of(getStaticSecurityCollectorItem(collectorItemId, "staticSecurityProjectName1", "http://nexusiq.com")));
    ...
    public void dataCleanLibraryPolicy() {
        ...
        when(dataSyncService.getCollectorItemRepository().findById(any(ObjectId.class))).thenReturn(java.util.Optional.of(getLibraryPolicyCollectorItem(collectorItemId, "libraryPolicyProjectName1", "http://whitesource.com")));
