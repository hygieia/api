...
public class TeamServiceImplTest {
    ...
    public void testGetTeam() {
        when(componentRepository.findById(mockComponentId)).thenReturn(java.util.Optional.ofNullable(mockComponent));
        when(collectorRepository.findById(mockItem2.getCollectorId())).thenReturn(java.util.Optional.ofNullable(mockJiraCollector));
