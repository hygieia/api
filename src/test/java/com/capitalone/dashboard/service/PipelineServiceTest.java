...
public class PipelineServiceTest {
    ...
    public void search() throws Exception {
        ...
        when(collectorItemRepository.findById(pipeline.getCollectorItemId())).thenReturn(java.util.Optional.of(dashboardCollectorItem));
        when(dashboardRepository.findById(new ObjectId((String)dashboardCollectorItem.getOptions().get("dashboardId")))).thenReturn(java.util.Optional.of(dashboard));
